...
parser.add_argument("--num_workers", type=int, default=80, help="Data loader num workers")
...
print(f"Train File : {os.path.join(in_path, f'{args.train_file}.npz')}")
print(f"Valid File : {os.path.join(in_path, f'{args.valid_file}.npz')}")
print(f"Num Tabs   : {args.num_tabs}")
print(f"Seq Len    : {args.seq_len}")
print(f"Epochs     : {args.train_epochs}")
print(f"Batch Size : {args.batch_size}")
print(f"Optimizer  : {args.optimizer}")
print(f"LR         : {args.learning_rate}")
print(f"LR Adjust  : {args.lradj}")
print(f"{'='*55}\n")

train_X, train_y = data_processor.load_data(
    os.path.join(in_path, f"{args.train_file}.npz"), args.feature, args.seq_len, args.num_tabs
)
valid_X, valid_y = data_processor.load_data(
    os.path.join(in_path, f"{args.valid_file}.npz"), args.feature, args.seq_len, args.num_tabs
)
